...
using RequestStatus =
        android::hardware::biometrics::fingerprint::V2_0::RequestStatus;
...
Return<uint64_t> BiometricsFingerprint::setNotify(
    ...
    // This is here because HAL 2.0 doesn't have a way to propagate a
...
fingerprint_device_t* BiometricsFingerprint::openHal() {
    ...
    if (kVersion != device->version) {
        // enforce version on new devices because of HIDL@2.0 translation layer
