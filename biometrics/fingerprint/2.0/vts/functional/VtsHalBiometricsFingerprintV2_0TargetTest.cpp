...
#include <android/hardware/biometrics/fingerprint/2.0/IBiometricsFingerprintClientCallback.h>
...
using android::hardware::biometrics::fingerprint::V2_0::FingerprintAcquiredInfo;
using android::hardware::biometrics::fingerprint::V2_0::FingerprintError;
