...
ScopedAStatus RadioNetwork::getDataRegistrationState(int32_t serial) {
    ...
    if (mHal1_6) {
        ...
        mHal1_4->getDataRegistrationState(serial);
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::getVoiceRegistrationState(int32_t serial) {
    ...
    if (mHal1_6) {
        ...
        mHal1_4->getVoiceRegistrationState(serial);
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setIndicationFilter(int32_t serial, int32_t indFilter) {
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setIndicationFilter_1_2(serial, toHidlBitfield<V1_2::IndicationFilter>(indFilter));
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setLinkCapacityReportingCriteria(  //
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setLinkCapacityReportingCriteria(  //
                serial, hysteresisMs, hysteresisDlKbps, hysteresisUlKbps, thrDownlinkKbps,
...
ScopedAStatus RadioNetwork::setNetworkSelectionModeManual(  //
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setNetworkSelectionModeManual(serial, opNumeric);
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setSignalStrengthReportingCriteria(
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setSignalStrengthReportingCriteria(serial, infos[0].hysteresisMs,
                                                    infos[0].hysteresisDb, infos[0].thresholds,
                                                    V1_2::AccessNetwork(infos[0].ran));
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setSystemSelectionChannels(  //
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setSystemSelectionChannels(serial, specifyCh, toHidl(specifiers));
    }
    return ok();
}
