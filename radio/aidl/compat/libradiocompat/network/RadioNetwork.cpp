...
ScopedAStatus RadioNetwork::setIndicationFilter(int32_t serial, int32_t indFilter) {
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setIndicationFilter_1_4(serial, toHidlBitfield<V1_4::IndicationFilter>(indFilter));
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setLinkCapacityReportingCriteria(  //
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setLinkCapacityReportingCriteria_1_4(  //
                serial, hysteresisMs, hysteresisDlKbps, hysteresisUlKbps, thrDownlinkKbps,
                thrUplinkKbps, V1_4::AccessNetwork(accessNetwork));
    }
    return ok();
}
...
ScopedAStatus RadioNetwork::setSignalStrengthReportingCriteria(
    ...
    if (mHal1_5) {
        ...
        mHal1_4->setSignalStrengthReportingCriteria_1_4(serial, toHidl(infos[0]),
                                                        V1_4::AccessNetwork(infos[0].ran));
    }
    return ok();
}
