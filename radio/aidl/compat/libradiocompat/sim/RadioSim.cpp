...
ScopedAStatus RadioSim::areUiccApplicationsEnabled(int32_t serial) {
    ...
    if (mHal1_5) {
        ...
        // TODO respond()->getUsageSettingResponse(notSupported(serial));
    }
    return ok();
}
...
ScopedAStatus RadioSim::changeIccPin2ForApp(int32_t serial, const std::string& oldPin2,
    ...
    LOG_CALL << serial;
    mHal1_4->changeIccPin2ForApp(serial, oldPin2, newPin2, aid);
    return ok();
}
...
ScopedAStatus RadioSim::getFacilityLockForApp(  //
    ...
    LOG_CALL << serial;
    mHal1_4->getFacilityLockForApp(serial, facility, password, serviceClass, appId);
    return ok();
}

ScopedAStatus RadioSim::getIccCardStatus(int32_t serial) {
    LOG_CALL << serial;
    mHal1_4->getIccCardStatus(serial);
    return ok();
}

ScopedAStatus RadioSim::getImsiForApp(int32_t serial, const std::string& aid) {
    LOG_CALL << serial;
    mHal1_4->getImsiForApp(serial, aid);
    return ok();
}
...
ScopedAStatus RadioSim::iccCloseLogicalChannel(int32_t serial, int32_t channelId) {
    LOG_CALL << serial;
    mHal1_4->iccCloseLogicalChannel(serial, channelId);
    return ok();
}
...
ScopedAStatus RadioSim::iccTransmitApduLogicalChannel(int32_t serial,
    ...
    LOG_CALL << serial;
    mHal1_4->iccTransmitApduLogicalChannel(serial, toHidl(message));
    return ok();
}

ScopedAStatus RadioSim::reportStkServiceIsRunning(int32_t serial) {
    LOG_CALL << serial;
    mHal1_4->reportStkServiceIsRunning(serial);
    return ok();
}
...
ScopedAStatus RadioSim::requestIccSimAuthentication(  //
    ...
    LOG_CALL << serial;
    mHal1_4->requestIccSimAuthentication(serial, authContext, authData, aid);
    return ok();
}
...
ScopedAStatus RadioSim::sendTerminalResponseToSim(int32_t serial,
    ...
    LOG_CALL << serial;
    mHal1_4->sendTerminalResponseToSim(serial, commandResponse);
    return ok();
}
...
ScopedAStatus RadioSim::setAllowedCarriers(  //
    ...
    LOG_CALL << serial;
    mHal1_4->setAllowedCarriers_1_4(serial, toHidl(carriers), V1_4::SimLockMultiSimPolicy(mp));
    return ok();
}
...
ScopedAStatus RadioSim::setCarrierInfoForImsiEncryption(
    ...
    if (mHal1_6) {
        ...
        mHal1_4->setCarrierInfoForImsiEncryption(serial, toHidl(imsiEncryptionInfo));
    }
    return ok();
}
...
ScopedAStatus RadioSim::setCdmaSubscriptionSource(int32_t serial,
    ...
    LOG_CALL << serial;
    mHal1_4->setCdmaSubscriptionSource(serial, V1_0::CdmaSubscriptionSource(cdmaSub));
    return ok();
}
...
ScopedAStatus RadioSim::setFacilityLockForApp(  //
        ...
        int32_t serviceClass, const std::string& appId) {
    LOG_CALL << serial;
    mHal1_4->setFacilityLockForApp(serial, facility, lockState, password, serviceClass, appId);
    return ok();
}
...
ScopedAStatus RadioSim::setSimCardPower(int32_t serial, aidl::CardPowerState powerUp) {
    ...
    if (mHal1_6) {
        ...
        mHal1_4->setSimCardPower_1_1(serial, V1_1::CardPowerState(powerUp));
    }
    return ok();
}
...
ScopedAStatus RadioSim::setUiccSubscription(int32_t serial, const aidl::SelectUiccSub& uiccSub) {
    LOG_CALL << serial;
    mHal1_4->setUiccSubscription(serial, toHidl(uiccSub));
    return ok();
}
...
ScopedAStatus RadioSim::supplyIccPin2ForApp(int32_t serial, const std::string& pin2,
    ...
    LOG_CALL << serial;
    mHal1_4->supplyIccPin2ForApp(serial, pin2, aid);
    return ok();
}
...
ScopedAStatus RadioSim::supplyIccPinForApp(int32_t serial, const std::string& pin,
                                           const std::string& aid) {
    LOG_CALL << serial;
    mHal1_4->supplyIccPinForApp(serial, pin, aid);
    return ok();
}
...
ScopedAStatus RadioSim::supplyIccPuk2ForApp(int32_t serial, const std::string& puk2,
    ...
    LOG_CALL << serial;
    mHal1_4->supplyIccPuk2ForApp(serial, puk2, pin2, aid);
    return ok();
}
...
ScopedAStatus RadioSim::supplyIccPukForApp(int32_t serial, const std::string& puk,
    ...
    LOG_CALL << serial;
    mHal1_4->supplyIccPukForApp(serial, puk, pin, aid);
    return ok();
}
...
ScopedAStatus RadioSim::supplySimDepersonalization(int32_t serial, aidl::PersoSubstate pss,
    ...
    if (mHal1_5) {
        ...
        mHal1_4->supplySimDepersonalization(serial, V1_4::PersoSubstate(pss), controlKey);
    }
    return ok();
}
